 ...
 * NAHM: 
 * 
 * 	Test Restful Web Services in S.B:
 * 		
 * 
 * Key Technologies: 
 * 	
 ...
 * 
 *  			Mock object: to create mock for the dependency UserService
 *  
 *  			MockMVC: of Spring Boot Test- to performe requests and verify responses to the service
 *  
 ...
 * NOTES: 
 * 		
 * 	Test Only code in the controller class
 * 
 *  Mock all dependencies of the controller - services , repo... 
 *  
 *  Mock data for dependencies(input and ouput) 
 *  
 *  @WebMvcTest: 
 *  
 *  		- To test only the controller - provided by spring boot test  
 *  
 *  		-Specify the class Controler class I want to test 
 *  
 *  		- S.B will load only this controller .class)
 *  
 *  @MockBean:
 *  
 *  		To mock the UserService  dependency 
 *    
 *  
 *  MockMvc:
 *  
 ...
 * ObjectMapper 
 * 
 * 		-to Convert POJO and JSON - jackson
 *  
 *  
 *  
 * Mockito APIs: 
 *   	
 *   
 * Note: I use Spring Security - Mock UserRepository 
 *   	
 *  
 *  
 *  NOTE IN THE INTEGERATION TESTS - NO MOCKITO - ONLY SPRING MVC TEST TO PERFORM REQUESTS
 *  
 */
 ...
 *  
 *  For testing the many-to-many relationship between Book and Author entities, 
 *  we will create a test method that saves one Author record and two Book records.
 */
